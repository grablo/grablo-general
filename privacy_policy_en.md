...
**Effective Date: May 7, 2026** (originally effective August 8, 2025; billing-records provisions amended effective October 1, 2026)
...
- We do **not** store raw payment credentials (card or bank account numbers); payments for paid services are processed by external payment providers, and we keep only minimal transaction records
...
- **Billing records** — only if you purchase a paid service: product purchased (subscription plan or paid template), amount and currency, payment timestamps, payment-method type, the payment processor's transaction and recurring-billing identifiers, and refund/cancellation records. Raw payment credentials (card or bank account numbers) are handled by the payment processor and are never collected or stored by Grablo.
...
- **Raw payment credentials** — card and bank account numbers are processed by external payment providers and never stored by Grablo (see Section 2.3, Billing records).
...
| Records of contracts and withdrawal of offers | 5 years (Korea Act on the Consumer Protection in Electronic Commerce) |
| Records of payments and supply of goods/services | 5 years (Korea Act on the Consumer Protection in Electronic Commerce) |
| Electronic financial transaction records | 5 years (Korea Electronic Financial Transactions Act) |
...
Payment processing and recurring billing for paid services are entrusted to an external payment processor; the processor will be added to this table when engaged. Payments for users outside Korea may be handled by a merchant of record, which will likewise be disclosed here when introduced.
